...
bool check(Point p1, Point p2, Point p3, Point p4) {
	if(2LL * trigonometric_sense(p1, p2, p3) * trigonometric_sense(p1, p2, p4) > 0) { return false; }
	if(2LL * trigonometric_sense(p3, p4, p1) * trigonometric_sense(p3, p4, p2) > 0) { return false; }
	return true;
}
